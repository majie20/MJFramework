...
namespace Hotfix
{
    public class LifecycleSystem : IDisposable
    {
        ...
        private StaticLinkedListDictionary<Model.Component, IStartSystem>       starts                 = new(5, 50);
        private StaticLinkedListDictionary<Model.Component, IUpdateSystem>      updates                = new(5, 50);
        private StaticLinkedListDictionary<Model.Component, ILateUpdateSystem>  lateUpdates            = new(5, 50);
        private StaticLinkedListDictionary<Model.Component, IFixedUpdateSystem> fixedUpdates           = new(5, 50);
        ...
        private List<Model.Component>                                           removeStartList        = new();
        private List<Model.Component>                                           removeUpdateList       = new();
        private List<Model.Component>                                           removeLateUpdateList   = new();
        private List<Model.Component>                                           removeFixedUpdateList  = new();
        private Dictionary<string, Model.FunctionSortAttribute>                 functionSortAttributes = new();
        ...
        public void Start()
        {
            ...
            while (data.right != 0)
            {
                ...
                if (len == 0 || !removeStartList.Contains((Model.Component)data.element))
                {
                    data.element.Start();
                }
            }
        ...
        public void Update(float tick)
        {
            ...
            while (data.right != 0)
            {
                ...
                if (len == 0 || !removeUpdateList.Contains((Model.Component)data.element))
                {
        ...
        public void LateUpdate()
        {
            ...
            while (data.right != 0)
            {
                ...
                if (len == 0 || !removeLateUpdateList.Contains((Model.Component)data.element))
                {
        ...
        public void FixedUpdate(float tick)
        {
            ...
            while (data.right != 0)
            {
                ...
                if (len == 0 || !removeFixedUpdateList.Contains((Model.Component)data.element))
                {
        ...
        private bool Compare<T>(T c1, T c2, string methodName)
        {
            ...
            if (b2)
            {
                return attribute2.Layer == Model.FunctionLayer.Low;
            }
        ...
        private void AddFunctionSortAttribute(Type type, string methodName)
        {
            ...
            {
                var attribute = Model.ObjectHelper.GetFunctionSortAttribute(type, methodName);
