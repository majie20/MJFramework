...
public sealed class Box :  Bright.Config.BeanBase 
{
    ...
    public Box(int id, string name, string desc, int price, int upgrade_to_item_id, int? expire_time, bool batch_useable ) 
    {
        this.Id = id;
        this.Name = name;
        this.Desc = desc;
    ...
    public const int __ID__ = 1176348752;
