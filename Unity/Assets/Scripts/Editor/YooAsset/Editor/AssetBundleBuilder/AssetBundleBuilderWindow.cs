...
namespace YooAsset.Editor
{
	public class AssetBundleBuilderWindow : EditorWindow
	{
		...
		private void ExecuteBuild()
		{
            ...
            FMODUnity.EventManager.CopyToStreamingAssets(UnityEditor.EditorUserBuildSettings.activeBuildTarget);
            builder.Run(buildParameters);
            FMODUnity.EventManager.UpdateBankStubAssets(UnityEditor.EditorUserBuildSettings.activeBuildTarget);
		}
