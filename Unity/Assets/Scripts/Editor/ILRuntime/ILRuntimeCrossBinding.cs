...
public class ILRuntimeCrossBinding 
{
    ...
    static void GenerateCrossbindAdapter()
    {
        ...
        using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/Scripts/Model/ILBinding/Adapter/ProtoBufIExtensibleAdapter.cs"))
        {
            sw.WriteLine(ILRuntime.Runtime.Enviorment.CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(typeof(ProtoBuf.IExtensible), "Model"));
        }
        ...
        using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/Scripts/Model/ILBinding/Adapter/ModelEntityAdapter.cs"))
        {
            sw.WriteLine(ILRuntime.Runtime.Enviorment.CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(typeof(Model.Entity), "Model"));
        }
