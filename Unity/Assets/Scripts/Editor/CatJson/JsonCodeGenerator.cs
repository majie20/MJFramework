...
namespace CatJson.Editor
{
    ...
    public static partial class JsonCodeGenerator
    {
        ...
        public static void ClearJsonCode()
        {
            ClearGenCodeDir();
            ...
            UnityEngine.Debug.Log("清理已生成的Json解析-转换代码--完成！"); // MDEBUG:
            //EditorUtility.DisplayDialog("提示", "已清理", "确认");
        }

        [MenuItem("CatJson/预生成Json解析-转换代码")]
        public static void GenJsonCode()
        {
            ...
            UnityEngine.Debug.Log("预生成Json解析-转换代码--完成！"); // MDEBUG:
