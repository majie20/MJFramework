...
namespace Model
{
    ...
    public class MMTouchJoystick : MonoBehaviour, IDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        [Header("Camera")]
        ...
        public virtual void Initialize()
        {
            ...
            SetKnobTransform(this.transform.GetChild(0));
            _canvasGroup = _knobTransform.GetComponent<CanvasGroup>();
