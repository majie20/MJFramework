...
namespace MoreMountains.Tools
{
    ...
    public class MMTouchButton : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler, IPointerEnterHandler, ISubmitHandler
    {
        ...
        /// </summary>
        public virtual async void OnPointerDown(PointerEventData data)
        {
        ...
        protected virtual async UniTask InvokePressedFirstTime()
        {
            await UniTask.Delay(TimeSpan.FromSeconds(PressedFirstTimeDelay));
        ...
        /// </summary>
        public virtual async void OnPointerUp(PointerEventData data)
        {
        ...
        protected virtual async UniTask InvokeReleased()
        {
            await UniTask.Delay(TimeSpan.FromSeconds(ReleasedDelay));
