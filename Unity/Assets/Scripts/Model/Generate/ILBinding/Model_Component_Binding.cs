...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_Component_Binding
    {
        ...
        static StackObject* Dispose_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Model.Component instance_of_this_method = (Model.Component)typeof(Model.Component).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
