...
namespace Model
{
    ...
    /// 声音总控制器
    /// </summary>
    public class MusicManager : Component, IAwake
    {
        /// <summary>
        /// 所有音效
        /// </summary>
        ...
        public void Awake()
        {
            ...
            Game.Instance.EventSystem.AddListener<E_PlayMusic, string>(this, PlayMusic);
        }
        ...
        /// <returns></returns>
        public int PlaySound(string eventPath)
        {
            int id = SoundID;
        ...
        public void PlayMusic(string eventPath)
        {
            ...
            Music = CreateInstance(eventPath);
            Music.start();
