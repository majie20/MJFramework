...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Model_EventSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(Model.HotfixCloseUIViewEvent)};
            ...
            if (genericMethods.TryGetValue("AddListener", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Action), typeof(System.Object)))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.Invoke<Model.HotfixCloseUIViewEvent>();
        ...
        static StackObject* AddListener_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action @call = (System.Action)typeof(System.Action).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)8);
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.AddListener<Model.HotfixCloseUIViewEvent>(@call, @self);

            return __ret;
        }

        static StackObject* RemoveListener_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            instance_of_this_method.RemoveListener<Model.HotfixCloseUIViewEvent>(@self);
