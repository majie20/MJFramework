...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ProtoBuf_Extensible_Binding
    {
        ...
        static StackObject* GetExtensionObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ProtoBuf.IExtension @extensionObject = (ProtoBuf.IExtension)typeof(ProtoBuf.IExtension).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
