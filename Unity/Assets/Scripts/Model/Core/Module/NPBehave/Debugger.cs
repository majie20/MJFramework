    ...
    public class Debugger : MonoBehaviour
    {
        ...
        public static Blackboard CustomGlobalStats
        {
            get 
            {
                ...
                {
                    _customGlobalStats = Model.Game.Instance.Scene.GetComponent<Model.NPContextComponent>().GetSharedBlackboard("_GlobalStats");;
                }
        ...
        public Blackboard CustomStats
        {
            get 
            {
                ...
                {
                    _customStats = new Blackboard(CustomGlobalStats, Model.Game.Instance.Scene.GetComponent<Model.NPContextComponent>().GetClock());
                }
                return _customStats;
            }
        }
