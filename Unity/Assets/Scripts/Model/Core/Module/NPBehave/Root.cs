...
namespace NPBehave
{
    public class Root : Decorator
    {
        ...
        private NP_BaseBehaviorTree tree;
        public NP_BaseBehaviorTree Tree
        {
            private set
            {
                tree = value;
        ...
        {
            this.Init(blackboard, mainNode);
        }

        public Root(Blackboard blackboard, Clock clock, Node mainNode) : base("Root", mainNode)
        {
            this.Init(blackboard, clock, mainNode);
        }

        public void Init(Node mainNode)
        {
            base.Init(mainNode);
            this.mainNode = mainNode;
            var component = Model.Game.Instance.Scene.GetComponent<Model.NPContextComponent>();
            this.clock = component.GetClock();
            this.blackboard = component.HatchBlackboard(this.clock);
            this.SetRoot(this);
        }
        ...
        public void Init(Blackboard blackboard, Node mainNode)
        {
            ...
            this.mainNode = mainNode;
            this.clock = Model.Game.Instance.Scene.GetComponent<Model.NPContextComponent>().GetClock();
            this.SetRoot(this);
        }
        ...
        public override void Dispose()
        {
            ...
            Model.Game.Instance.Scene.GetComponent<Model.NPContextComponent>().RecycleBlackboard(this.blackboard);
        ...
        public void SetTree(NP_BaseBehaviorTree tree)
        {
            this.Tree = tree;
        }
