...
{
    unsafe class System_Collections_Generic_Dictionary_2_Type_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.Type, MGame.Model.IDisposableAdapter.Adapter>);
            ...
            args = new Type[]{typeof(System.Type), typeof(MGame.Model.IDisposableAdapter.Adapter)};
            method = type.GetMethod("Add", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Add_2);
            args = new Type[]{typeof(System.Type), typeof(MGame.Model.IDisposableAdapter.Adapter).MakeByRefType()};
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.Type, MGame.Model.IDisposableAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.Dictionary<System.Type, MGame.Model.IDisposableAdapter.Adapter>)typeof(System.Collections.Generic.Dictionary<System.Type, MGame.Model.IDisposableAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Add_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            MGame.Model.IDisposableAdapter.Adapter @value = (MGame.Model.IDisposableAdapter.Adapter)typeof(MGame.Model.IDisposableAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryGetValue_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            MGame.Model.IDisposableAdapter.Adapter @value = (MGame.Model.IDisposableAdapter.Adapter)typeof(MGame.Model.IDisposableAdapter.Adapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack));
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as MGame.Model.IDisposableAdapter.Adapter[];
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Dictionary<System.Type, MGame.Model.IDisposableAdapter.Adapter>();
