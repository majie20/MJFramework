...
{
    unsafe class MGame_Model_ComponentView_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(MGame.Model.ComponentView);
        ...
        static StackObject* set_isHotfix_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MGame.Model.ComponentView instance_of_this_method = (MGame.Model.ComponentView)typeof(MGame.Model.ComponentView).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        {
            return ((MGame.Model.ComponentView)o).dic;
        }

        static StackObject* CopyToStack_dic_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((MGame.Model.ComponentView)o).dic;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_dic_0(ref object o, object v)
        {
            ((MGame.Model.ComponentView)o).dic = (System.Collections.Generic.Dictionary<System.Object, System.Type>)v;
        }
        ...
        static StackObject* AssignFromStack_dic_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((MGame.Model.ComponentView)o).dic = @dic;
