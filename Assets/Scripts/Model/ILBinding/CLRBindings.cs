...
//will auto register in unity
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            System_Collections_Generic_IEnumerable_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding.Register(app);
            System_Collections_Generic_IEnumerator_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding.Register(app);
            System_Collections_IEnumerator_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding.Register(app);
            ...
            System_Collections_Generic_Queue_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding.Register(app);
            System_Collections_Generic_Queue_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding_Enumerator_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_Type_Queue_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding.Register(app);
            ...
            MGame_Model_EventSystem_Binding.Register(app);
            UnityEngine_Component_Binding.Register(app);
            MGame_Model_NetComponent_Binding.Register(app);
            ...
            System_Collections_Generic_Dictionary_2_Type_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding_ValueCollection_Binding.Register(app);
            System_Collections_Generic_Dictionary_2_Type_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding_ValueCollection_Binding_Enumerator_Binding.Register(app);
