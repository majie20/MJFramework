...
namespace ILRuntime.Runtime.Generated
{
    unsafe class DG_Tweening_DOTweenModuleUI_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, DOAnchorPos_0);
            ...
            args = new Type[]{typeof(UnityEngine.UI.Text), typeof(System.Single), typeof(System.Single)};
            method = type.GetMethod("DOFade", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, DOFade_3);


        }


        static StackObject* DOAnchorPos_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* DOFade_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
