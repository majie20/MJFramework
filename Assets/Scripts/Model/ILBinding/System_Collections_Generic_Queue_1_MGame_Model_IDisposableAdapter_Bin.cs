...
{
    unsafe class System_Collections_Generic_Queue_1_MGame_Model_IDisposableAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter>);
        ...
        static StackObject* Enqueue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            MGame.Model.IDisposableAdapter.Adapter @item = (MGame.Model.IDisposableAdapter.Adapter)typeof(MGame.Model.IDisposableAdapter.Adapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter> instance_of_this_method = (System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter>)typeof(System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter>();
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Queue<MGame.Model.IDisposableAdapter.Adapter>(@capacity);
